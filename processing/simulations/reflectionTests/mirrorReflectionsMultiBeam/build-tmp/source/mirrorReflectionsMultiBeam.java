...
public class mirrorReflectionsMultiBeam extends PApplet {

/*
    mirrorMultiBeamReflectionsExample
    ------------------------

    quick and dirty mirrorReflection implementation for processing
...
class MultiBeam {
  ...
  public void settings() {  size(1200, 1200, OPENGL);  smooth(8); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "mirrorReflectionsMultiBeam" };
    if (passedArgs != null) {
