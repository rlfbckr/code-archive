...
float attractor_move_speed = 0.9; // geschwindigkeit der attraktoren
float max_attraction_dist = 100; // je kleinder desto schneller..
float particle_echo_length = 10; // particle pos history... oder so
